...
- **hexgrad/Kokoro-TTS** (score: 7, source: huggingface, added: 2026-04-21) — Lightweight TTS model Homie could integrate for local voice output; tutorial on TTS pipelines [link](https://huggingface.co/spaces/hexgrad/Kokoro-TTS)

### Evaluating (scored >= 6)

- **Falconsai/nsfw_image_detection** (score: 6, source: huggingface, added: 2026-04-21) — Homie could use this as a local content safety filter plugin for image inputs [link](https://huggingface.co/Falconsai/nsfw_image_detection)
